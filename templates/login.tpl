    ...
    <form method="post" action="../php/log_calc.php">
        ...
        <div class="form-group">
            <div class="cols-sm-10">
                <div class="input-group mt-3">
                    <span class="input-group-addon"><i class="fa fa-users fa" aria-hidden="true"></i></span>
                    <input type="phone" class="form-control" name="phone" id="phone" placeholder="Номер телефона"
                           style="border-radius: 5px;" required/>
                </div>
            </div>
        </div>
        ...
        {if isset($warning1)}
            <p class="text-danger mb-0" style="font-size: 90%; "> {$warning1}</p>
            <a href="../pages/signup.php" class="text-warning ">Войти</a>
        {/if}
